...
class DiscussionsController extends ControllerBase
{
    ...
    protected function prepareQueries($joinReply = false)
    {
        ...
        if ($joinReply) {
            $itemBuilder
                ->groupBy("p.id")
                ->join('Jimi\Models\PostsReplies', "r.posts_id = p.id", 'r');
        }
