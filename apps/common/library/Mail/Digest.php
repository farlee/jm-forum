...
class Digest extends Injectable
{
    ...
    public function send()
    {
        ...
        $subject = 'Top Stories from Jimi ' . date('d/m/y');
        ...
        $content = '<html><head></head><body><p><h1 style="font-size:22px;color:#333;letter-spacing:-0.5px;line-height:1.25;font-weight:normal;padding:16px 0;border-bottom:1px solid #e2e2e2">Top Stories from Jimi</h1></p>';
